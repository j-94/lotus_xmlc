"""
Process the dataset with DirectOpenAILM.
This script uses our custom DirectOpenAILM implementation to process the dataset.
"""
...
# Function to assign labels using DirectOpenAILM
def assign_labels(text, label_names, label_descriptions, top_k=5):
    """
    Assign ontology labels to a text using DirectOpenAILM.
    ...
    try:
        ...
        # Use DirectOpenAILM to get the response
        response = direct_lm(prompt)
...
def main():
    ...
    output_path = "enriched_sample_direct_openai.csv"
    ...
    if process_full.lower() == 'y':
        ...
        output_path = "enriched_dataset_direct_openai.csv"
