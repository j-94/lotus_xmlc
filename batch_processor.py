"""
XMLC-LOTUS: Batch Processor for Bookmark Data Enrichment with Ontology Labels

This script processes the entire dataset without user interaction.
"""
...
def main():
    ...
    output_path = "enriched_dataset.csv"
